    ...
    <div class="container-fluid">
        ...
        ?>
            <div class="alert alert-danger">
                <b>Existed Brand ID</b>. Please try another. Thank you.
            </div>
            <hr>
        <?php
        }
        ?>
        <p>You can view all the brands here.</p>

        <div class="card mt3">
            <div class=" card-header">List of Brands
            ...
            <div class="card-body">
                ...
                <table class="table table-bordered table-hover">
                    <thead>
                        <tr>
                            <th width="150" style="text-align: center;">Brand D</th>
                            <th style=" text-align: left; padding-left: 10px">Brand Name</th>
                            <th width="100" style="text-align: center;">Status</th>
                        </tr>
                    </thead>
                    <tbody id="result">
                        <?php include("./models/brands.php"); ?>
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="card">
                        <form action="./models/brandsave.php" method="POST">
                            <div class="card-body">


                                <div class="form-group">
                                    <label for="productCode">Brand ID</label>
                                    <input name="inp_BrandId" required type="text" placeholder="Enter Supplier ID here.." class="form-control mt-2">
                                </div>
                                <div class="form-group">
                                    <label for="productName">Brand Name</label>
                                    <input name="inp_bName" required type="text" placeholder="Enter Brand Name here.." class="form-control mt-2">
                                </div>
                                <div class="form-group">
                                    <label>Brand Status: <b class="text-danger">*</b></label>
                                    <select name="inp_status" required class="form-control mt-2">
